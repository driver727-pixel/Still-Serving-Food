 ...
 * facebookResolver.js
 *
 * Phase 2 of the hybrid pipeline: Facebook URL Resolution.
 *
 * For each business entity retrieved in Phase 1, find its Facebook page URL
 * using a two-step strategy:
 *
 *   Fast path  – The `website` field from Google Places IS a Facebook page.
 *   Slow path  – Scrape the business homepage with Firecrawl and extract
 *                any Facebook page link from the rendered HTML/links list.
 *
...
module.exports = { resolveFacebookUrl, isFacebookUrl, normaliseFacebookUrl };
